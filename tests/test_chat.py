...
@patch(
    ...
    return_value={
        "synthesis_prompt": "Mocked Falcon AI response"
    }
)
@patch(
...
@patch(
    "app.services.chat_service.model_router.generate_with_meta",
    return_value=("Mocked Falcon AI response", type("Decision", (), {"provider": "test", "model": "mock"})()),
)
...
@patch(
    "app.services.chat_service.model_router.generate_with_meta",
    return_value=(
        "Falcon AI was created to help businesses analyze problems and make better decisions.",
        type("Decision", (), {"provider": "test", "model": "mock"})(),
    ),
)
@patch(
    "app.services.chat_service.create_plan",
...
@patch(
    ...
    return_value={
        "synthesis_prompt": (
            "Falcon AI was created to help businesses "
            "analyze problems and make better decisions."
        )
    }
)
